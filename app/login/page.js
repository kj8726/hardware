    ...
    <div className="min-h-screen flex items-center justify-center pt-16 pb-12 px-4 grid-bg">
      ...
      <div className="relative w-full max-w-md animate-fade-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-black text-3xl text-brand-light">WELCOME BACK</h1>
        ...
        <div className="bg-brand-card border border-brand-border rounded-2xl p-8 shadow-card">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-brand-dark hover:bg-brand-dark/80 border border-brand-border hover:border-brand-orange/30 text-brand-light font-medium py-3 px-4 rounded-lg transition-all duration-200 mb-6 disabled:opacity-60"
          >
            {googleLoading ? (
              <svg className="w-5 h-5 animate-spin text-brand-orange" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3" className="opacity-25"/><path fill="currentColor" d="M4 12a8 8 0 018-8v8H4z" className="opacity-75"/></svg>
            ) : (
          ...
          <p className="text-center text-brand-muted text-sm mt-6">
            No account?{" "}
            <Link href="/register" className="text-brand-orange hover:underline font-medium">Create one free</Link>
          </p>
        </div>
      </div>
    </div>
